...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/becks/mediator-bot/build/install/${idir}'.  Ask the maintainer 'Becks <beccalouisesimpson@googlemail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/becks/mediator-bot/build/install/lib;/home/becks/mediator-bot/build/devel/lib;/home/becks/catkin_ws/devel/lib;/opt/ros/indigo/lib)
